...
pprec <-ggplot() +
       ...
       geom_line(data=kk, aes(x=dateok, y=(presion-980)*escala, color="cpres"),size=0.8,stat="identity")+
...
ptemp <- ggplot() +
        geom_line(data=kk,aes(x=dateok,y=temp,color="red"),size=0.8)+
        geom_line(data=kk,aes(x=dateok,y=trocio,color="green3"),size=0.8)+
        geom_line(data=kk,aes(x=dateok,y=a+ b*hum ,color="cyan3"),size=0.6, linetype = "dashed")+
...
pprec <-ggplot() +
       geom_bar(data=kkdia, aes(x=dateok, y=precip, fill="lightblue"), alpha=0.5, col="deepskyblue4", stat="identity") +
       ...
       scale_fill_manual('', labels = c("Precipitacion (mm)"), values = c("lightblue"="lightblue")) +
       ...
       theme(legend.position = "bottom", legend.title= element_blank(), legend.key=element_blank(), legend.box="horizontal",
              ...
              panel.grid.major = element_line(size = 0.5, linetype = 'solid', colour = "grey"),
              panel.grid.minor = element_line(size = 0.25, linetype = 'dashed',  colour = "white"),
              axis.line.y = element_line(color = "deepskyblue3"),
              axis.text.y = element_text(color = "deepskyblue3"),
